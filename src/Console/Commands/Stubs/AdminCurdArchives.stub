                                                ...
                                                <ul class="nav navbar-center navbar-top-links" style="border-radius: 15px;">
                                                    <li class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-user">
                                                            <li >
                                                                <button class="dropdown-item btn btn-danger openBackFrom" data-toggle="modal" data-target="#myModalBack" data-id="{{$admin->id}}">
                                                                    back
                                                                </button>
                                                            </li>
                                                        </ul>
        ...
        $(document).ready(function() {
            $(document).on('click', '#load_more_button', function() {
                ...
                function load_data(_token) {
                    $.ajax({
                        url: `{{ route("admin/admins/pagination/archives")}}/${offset}/${limit}`,
                        method: "POST",
                        data: {
                            id: id,
                            _token: _token,
